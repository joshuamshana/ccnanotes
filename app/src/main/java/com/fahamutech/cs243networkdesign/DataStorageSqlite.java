...
public class DataStorageSqlite extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "NetworkDesignNotes.db";
    public static final String CONTACTS_TABLE_NAME = "network";
    ...
    public boolean updateContact (Integer id,
        ...
        contentValues.put("place", place);
        db.update("contacts",
                contentValues, "id = ? ", new String[] { Integer.toString(id) } );
        return true;
    }
